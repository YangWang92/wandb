...
def op_key(cls: type[OpDict]) -> str:
...
class And(OpDict):
    inner: tuple[Any, ...] = Field(default=(), alias="$and")


class Or(OpDict):
    inner: tuple[Any, ...] = Field(default=(), alias="$or")


class Nor(OpDict):
    inner: tuple[Any, ...] = Field(default=(), alias="$nor")
...
class In(OpDict):
    inner: tuple[Scalar, ...] = Field(default=(), alias="$in")


class NotIn(OpDict):
    inner: tuple[Scalar, ...] = Field(default=(), alias="$nin")
